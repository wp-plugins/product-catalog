...
//      exit;
      ...
      $wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix."huge_it_catalog_params SET  value='%s'  WHERE name = 'ht_catalog_general_admin_email_message' ", $adminMessage));
      $wpdb->query($wpdb->prepare("UPDATE ".$wpdb->prefix."huge_it_catalog_params SET  value='%s'  WHERE name = 'ht_catalog_general_user_message' ", $userMessage));
